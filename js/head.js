...
document.writeln("                    <a href=\'explore.html\'>Gallery</a>");
document.writeln("                    <ul class=\'dropdown\'>");
document.writeln("                      <li><a href=\'gallery.html?gallery=Civic_Art\' onclick=getMess()>Civic Art</a></li>");
document.writeln("                      <li><a href=\'gallery.html?gallery=Makers_in_Residence\'>Makers in Residence</a></li>");
document.writeln("                      <li><a href=\'gallery.html?gallery=From_the_Heart\'>From the Heart</a></li>");
document.writeln("                      <li class=\'has-children\'>");
document.writeln("                        <a href=\'#\'>Past Guides</a>");
document.writeln("                        <ul class=\'dropdown\'>");
document.writeln("                          <li><a href=\'#\'>Guide One</a></li>");
document.writeln("                          <li><a href=\'#\'>Guide Two</a></li>");
document.writeln("                        </ul>");
document.writeln("                      </li>");
document.writeln("                    </ul>");
document.writeln("                  </li>");
